...
import curl_cffi
from scraper_engine.loggers.configs import logging_setup
from scraper_engine.handlers.response_handler import HttpResponse

CLIENT_IDENTIFIER = os.getenv("CLIENT_IDENTIFIER")
logging_setup.create_dictconfig()
